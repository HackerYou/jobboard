...
<<<<<<< HEAD
          <input type="text" name="searchTerm" id="searchTerm" placeholder='search'  onChange={this.handleChange} value={this.state.keywords} /> 
          <select name="jobLocation" id="jobLocation" onChange={this.handleChange}>
            <option name="jobLocation" id="locationOption" defaultValue disabled >Location</option>
          ...
          <p onClick={this.toggleAdvancedSearch}>+advanced search</p>
            {this.state.advancedSearch &&   <div className="advanced">
                <select name="timeSincePosting" id="timeSincePosting" onChange={this.handleChange} placeholder="time since posting">
                  <option name="timeSincePosting" value="" id="timeSincePostingOption" defaultValue disabled>Time Since Posting</option>
                ...
                <select name="salary" id="salary" onChange={this.handleChange} >
                  <option name="salary" value="" id="salaryOption" defaultValue disabled>Salary</option>
                ...
                <select name="jobCommitment" id="jobCommitment" onChange={this.handleChange} >
                  <option name="jobCommitment" value='' id="commitment" defaultValue disabled>Commitment</option>
...
=======
          <div className="searchTop">
            ...
            <button className="searchButton"><img src="../../../assets/icon-search.svg" alt="Click to search"/></button>
